(() => {
  ...
  var require_color = __commonJS({
    "node_modules/color/index.js"(exports, module) {
      ...
      var limiters = {};
      function Color4(object, model) {
        if (!(this instanceof Color4)) {
          return new Color4(object, model);
        }
        ...
        if (object == null) {
          ...
          this.color = [0, 0, 0];
          this.valpha = 1;
        } else if (object instanceof Color4) {
      ...
      Color4.prototype = {
        ...
        round(places) {
          ...
          return new Color4([...this.color.map(roundToPlace(places)), this.valpha], this.model);
        },
        alpha(value) {
          if (value !== void 0) {
            return new Color4([...this.color, Math.max(0, Math.min(1, value))], this.model);
          }
          return this.valpha;
        },
        // Rgb
        ...
        grayscale() {
          ...
          return Color4.rgb(value, value, value);
        },
        fade(ratio) {
      ...
      for (const model of Object.keys(convert)) {
        ...
        Color4.prototype[model] = function(...args) {
          if (this.model === model) {
            return new Color4(this);
          }
          if (args.length > 0) {
            return new Color4(args, model);
          }
          return new Color4([...assertArray(convert[this.model][model].raw(this.color)), this.valpha], model);
        };
        Color4[model] = function(...args) {
          let color = args[0];
          if (typeof color === "number") {
            color = zeroArray(args, channels);
          }
          return new Color4(color, model);
        };
      }
  ...
  var init_square = __esm({
    "src/modules/square.js"() {
      ...
      Square = class {
        ...
        draw() {
          var color = (0, import_color.default)(this.color);
  ...
  var import_color2, Circle;
  var init_circle = __esm({
    "src/modules/circle.js"() {
      import_color2 = __toESM(require_color());
      Circle = class {
        ...
        draw() {
          var color = (0, import_color2.default)(this.color);
          this.ctx.fillStyle = color;
          this.ctx.strokeStyle = color.desaturate(0.4).darken(0.25).hex();
          this.ctx.lineWidth = 3;
          this.ctx.lineJoin = "miter";
  ...
  var import_color3, Triangle;
  var init_triangle = __esm({
    "src/modules/triangle.js"() {
      import_color3 = __toESM(require_color());
      Triangle = class {
        constructor(ctx, listId, length, x, y, color) {
          this.ctx = ctx;
          this.listId = listId;
        ...
        draw(angle = 0) {
          var color = (0, import_color3.default)(this.color);
          this.ctx.fillStyle = color;
          this.ctx.strokeStyle = color.desaturate(0.4).darken(0.25).hex();
          this.ctx.lineWidth = 3;
          this.ctx.lineJoin = "miter";
          ...
          this.ctx.lineTo(this.x + this.length * Math.cos(degToRad2(angle)), this.y - this.length * Math.sin(degToRad2(angle)));
          this.ctx.lineTo(this.x + this.length * Math.cos(degToRad2(60 - angle)), this.y + this.length * Math.sin(degToRad2(60 - angle)));
  ...
  var triangleBtn = document.querySelector(".triangle");
  var myCanvas = new Canvas("myCanvas", document.body, 480, 320);
  myCanvas.create();
  myCanvas.createReportList();
  squareBtn.addEventListener("click", () => {
    Promise.resolve().then(() => (init_square(), square_exports)).then((Module) => {
      let square1 = new Module.Square(myCanvas.ctx, myCanvas.listId, 115, 40, 40, "hsl(290, 94%, 30%)");
      square1.draw();
      square1.reportArea();
  ...
  circleBtn.addEventListener("click", () => {
    Promise.resolve().then(() => (init_circle(), circle_exports)).then((Module) => {
      let circle1 = new Module.Circle(myCanvas.ctx, myCanvas.listId, 75, 320, 100, "green");
      circle1.draw();
      circle1.reportArea();
  ...
  triangleBtn.addEventListener("click", () => {
    Promise.resolve().then(() => (init_triangle(), triangle_exports)).then((Module) => {
      let triangle1 = new Module.Triangle(myCanvas.ctx, myCanvas.listId, 100, 125, 190, "yellow");
      triangle1.draw(11);
